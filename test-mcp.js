...
import { handleCVQuestion } from "./src/server/tools/cv-chat.js";
import { handleEmailSend } from "./src/server/tools/email-sender.js";
...
async function testMCPServer() {
	...
	try {
		...
		console.log("❌ CV Chat Error:", error.message);
	}
